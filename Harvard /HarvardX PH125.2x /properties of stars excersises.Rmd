---
title: "Properties of Stars Exercises"
output: html_notebook
---
This comprehensive assessment is available to verified learners only.
...
IMPORTANT: These exercises use dslabs datasets that were added in a July 2019 update. Make sure your package is up to date by reinstalling the package with the command install.packages("dslabs").
...
The least lumninous star in the sample with a surface temperature over 5000K is ________
...
These are the two stars in the upper right corner.
...
The Sun is on the main diagonal and is therefore a main sequence star.
...
The coolest stars at the right of the plot are type M.
...
The hottest star at the left of the plot is type O.
...
The most luminous G-type star is a dwarf with a cooler temperature.
